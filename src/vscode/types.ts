...
import { illegalArgument } from '../vscode/errors'
...
export class CodeActionKind {
  ...
  public contains(other: CodeActionKind): boolean {
    return (
      ...
      startsWith(other.value, this.value + CodeActionKind.sep)
    )
  }
}
...
export class SelectionRangeKind {
  ...
  append(value: string): SelectionRangeKind {
    return new SelectionRangeKind(
      this.value ? this.value + SelectionRangeKind._sep + value : value
    )
  }
}
