// https://raw.githubusercontent.com/Microsoft/vscode/master/src/vs/base/common/async.ts
/*---------------------------------------------------------------------------------------------
...
} from '../vscode/cancellation'
import * as errors from '../vscode/errors'
import { Emitter, Event } from '../vscode/event'
import { Disposable, IDisposable } from '../vscode/lifecycle'
...
export function ninvoke(thisArg: any, fn: Function, ...args: any[]): any {
  return new Promise((resolve, reject) =>
    fn.call(thisArg, ...args, (err: any, result: any) =>
