// https://raw.githubusercontent.com/Microsoft/vscode/master/src/vs/base/common/arrays.ts
/*---------------------------------------------------------------------------------------------
 *  Copyright (c) Microsoft Corporation. All rights reserved.
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/

import { CancellationToken } from '../vscode/cancellation'
import { canceled } from '../vscode/errors'
import { ISplice } from '../vscode/sequence'
...
export function isNonEmptyArray<T>(
  obj: ReadonlyArray<T> | undefined | null
): obj is Array<T> {
  return Array.isArray(obj) && obj.length > 0
}
