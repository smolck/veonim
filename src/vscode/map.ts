// https://raw.githubusercontent.com/Microsoft/vscode/master/src/vs/base/common/map.ts
/*---------------------------------------------------------------------------------------------
...
import { Iterator, IteratorResult, FIN } from '../vscode/iterator'

export function values<V = any>(set: Set<V>): V[]
export function values<K = any, V = any>(map: Map<K, V>): V[]
// @ts-ignore
export function values<V>(forEachable: {
  forEach(callback: (value: V, ...more: any[]) => any)
}): V[] {
  const result: V[] = []
...
export function mapToSerializable(
...
export function serializableToMap(
